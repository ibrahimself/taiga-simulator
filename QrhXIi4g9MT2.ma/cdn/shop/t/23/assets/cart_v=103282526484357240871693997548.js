...
Line 79:16 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 82:4 Transforming const to the configured target environment ("es5") is not supported yet
Line 94:8 Transforming const to the configured target environment ("es5") is not supported yet
