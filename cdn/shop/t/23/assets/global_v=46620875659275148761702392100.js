...
Line 47:45 Transforming default arguments to the configured target environment ("es5") is not supported yet
Line 101:2 Transforming const to the configured target environment ("es5") is not supported yet
...
Line 139:40 Transforming default arguments to the configured target environment ("es5") is not supported yet
Line 150:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 153:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 159:0 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 160:13 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
... and 199 more hidden warnings
...
class VariantSelects extends HTMLElement {
  ...
  onVariantChange() {
    ...
    if (!this.currentVariant) {
      ...
      var apartirede = document.getElementById('apartirede');
      apartirede.style.display = 'none';
  }
...
// change name of color in simgle prod

$(document).ready(function() {
    $('div.drawer__cart-item__details__items dd').text(function(i, oldText) {
      switch(oldText){
